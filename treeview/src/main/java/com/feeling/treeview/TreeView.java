...
import com.feeling.treeview.base.SelectableTreeAction;
...
public class TreeView implements SelectableTreeAction {
    ...
    public void setTreeToggleListener(OnNodeToggleListener listener){
        adapter.setToggleListener(listener);
    }
}

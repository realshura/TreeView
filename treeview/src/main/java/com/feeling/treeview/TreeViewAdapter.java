...
import com.feeling.treeview.helper.TreeHelper;
...
public class TreeViewAdapter extends RecyclerView.Adapter {
    ...
    private OnNodeToggleListener mToggleListener;
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
            ...
            nodeView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (mToggleListener != null) {
                        result = mToggleListener.onNodeToggled(treeNode, !treeNode.isExpanded());
                    }
                    if (result) {
                        onNodeToggled(treeNode);
                        viewBinder.onNodeToggled(treeNode, treeNode.isExpanded());
        ...
        if (viewBinder instanceof CheckableNodeViewBinder) {
            ...
            if (view != null && view instanceof ImageView) {
                ...
                checkableView.setSelected(treeNode.isSelected());
                checkableView.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        boolean checked = checkableView.isSelected();
                        checkableView.setSelected(!checked);
...
//        selectParentIfNeed(treeNode, checked);
    ...
    public void setToggleListener(OnNodeToggleListener mToggleListener) {
